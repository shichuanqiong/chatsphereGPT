  ...
  return (
    <div className="h-[100svh] w-full text-white relative overflow-hidden flex flex-col">
      ...
      <div id="app-shell" className="flex-1 flex flex-col min-h-0">
        ...
        {/* 右侧广告栏 */}
        <aside id="ads-right" className="hidden md:block w-rail shrink-0 h-full overflow-y-auto space-y-4" style={{ width: 300, display: window.innerWidth >= 768 ? 'block' : 'none' }}>
